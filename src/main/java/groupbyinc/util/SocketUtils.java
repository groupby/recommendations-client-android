...
// TODO add this to common-utils
// Instead of being its own floating code snippet
...
public abstract class SocketUtils {
     ...
     * this constructor is intentionally {@code public}. <h4>Rationale</h4>
     * <p/>
     ...
     * <p/>
     * <pre>
     * <code>&lt;bean id="bean1" ... p:port="#{T(org.springframework.SocketUtils).findAvailableTcpPort(12000)}"
     * /
     &gt;</code>
     *</pre>
     *<p/>
     ...
     *
     ...
     's {@code T()} function for each *usage.Thus,
     the fact
     that this
     constructor is
     ...
     *<code>&lt;
     bean id = "socketUtils"
     class="org.springframework.SocketUtils"/&gt;
     *&lt;
     bean id = "bean1"
     ...p:port="#{socketUtils.findAvailableTcpPort(12000)}"/&gt;
     *&lt;
     bean id = "bean2"
     ...p:port="#{socketUtils.findAvailableTcpPort(30000)}"/&gt;</code>
     *</pre>
     */
